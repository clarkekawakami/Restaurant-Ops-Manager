...
import { DashboardStats, StaffMember } from '../types.ts';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16 gap-3">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <div className="w-10 h-10 rounded-xl bg-slate-900 dark:bg-slate-800 text-white flex items-center justify-center shadow-xs border border-transparent dark:border-slate-700">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 hidden sm:block">Operations & Payroll Manager</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg bg-slate-900 dark:bg-amber-500 dark:hover:bg-amber-400 text-white dark:text-slate-950 hover:bg-slate-800 transition cursor-pointer shadow-2xs"
            >
              <CircleDot className="w-3.5 h-3.5 text-emerald-400 dark:text-slate-950" />
